...
// `<go-gocam-viewer>` is a Stencil custom element registered at runtime by
...
declare module 'react' {
  namespace JSX {
    interface IntrinsicElements {
      'go-gocam-viewer': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement> & {
        'show-legend'?: boolean
      }
    }
  }
